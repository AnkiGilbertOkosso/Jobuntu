<div class="w-1/4 relative h-screen bg-white p-4 rounded border-r hidden md:block">
    ...
    <ul class="space-y-2 pt-4">
        ...
        <li><a href="../src/appliedjobs.html" class="flex p-2 text-gray-700 hover:bg-gray-100 rounded">
                ...
                <span class="pl-3">Applied Jobs</span></a></li>
        <li><a href="post-job.html" class="flex p-2 text-gray-700 hover:bg-gray-100 rounded">
                <svg viewBox="0 0 24 24" fill="none" width="24px" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path
                            ...
                            stroke="rgb(55 65 81 )" stroke-width="2" stroke-linejoin="round"></path>
                    </g>
                </svg>
                <span class="pl-3">Favorite Job</span></a></li>
        <li><a href="my-jobs.html" class="flex p-2 text-gray-700 hover:bg-gray-100 rounded">
                <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="24px"
                    fill="rgb(55 65 81 / var(--tw-text-opacity))" stroke="">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
