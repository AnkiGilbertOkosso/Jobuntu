        ...
        <form action="{{ route('candidate.saveProfileStep') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="flex flex-col space-y-3 col-span-1 items-start justify-center w-full">
                    ...
                    <label for="profile_picture" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:border-gray-600">
                        ...
                        @if($candidate && $candidate->profile_picture)
                            <img src="{{ Storage::url($candidate->profile_picture) }}" alt="Profile Picture" class="mt-3 w-full h-64 object-cover rounded-lg" />
                        @endif
                    </label>
                </div>
                <div class="col-span-2 grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="full_name" name="full_name" placeholder="" value="{{ old('full_name', $candidate->full_name ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" placeholder="" value="{{ old('title', $candidate->title ?? '') }}"
                               class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-primary focus:ring-primary focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                    <div>
                        <label for="experience" class="block text-gray-700 text-sm font-bold mb-2">Experience</label>
                        <input type="text" id="experience" name="experience" placeholder="" value="{{ old('experience', $candidate->experience ?? '') }}"
                               class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-primary focus:ring-primary focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                    <div>
                        <label for="education" class="block text-gray-700 text-sm font-bold mb-2">Education</label>
                        <input type="text" id="education" name="education" placeholder="" value="{{ old('education', $candidate->education ?? '') }}"
                               class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-primary focus:ring-primary focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                    <div class="col-span-2">
                        <label for="personal_website" class="block text-gray-700 text-sm font-bold mb-2">Personal Website</label>
                        <input type="text" id="personal_website" name="personal_website" placeholder="" value="{{ old('personal_website', $candidate->personal_website ?? '') }}"
                               class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-primary focus:ring-primary focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                </div>
            </div>
        ...
        <form action="{{ route('candidate.saveProfileStep') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div class="mb-4">
                    ...
                    <select class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="nationality" name="nationality">
                        <option value="">Select...</option>
                        <option value="American" {{ old('nationality', $candidate->nationality) == 'American' ? 'selected' : '' }}>American</option>
                        <option value="Canadian" {{ old('nationality', $candidate->nationality) == 'Canadian' ? 'selected' : '' }}>Canadian</option>
                        <!-- Add more options as needed -->
                    </select>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="date_of_birth">Date Of Birth</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="date_of_birth" name="date_of_birth" type="date" value="{{ old('date_of_birth', $candidate->date_of_birth ?? '') }}">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="gender">Gender</label>
                    <select class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="gender" name="gender">
                        <option value="">Select...</option>
                ...
                <div class="mb-4">
                    ...
                    <select class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="marital_status" name="marital_status">
                        <option value="">Select...</option>
                ...
                <div class="md:col-span-2 mb-4">
                    ...
                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32" id="biography" name="biography" placeholder="Add your Biography...">{{ old('biography', $candidate->biography ?? '') }}</textarea>
                </div>
            </div>
            <div class="items-center justify-end flex mt-4">
                <button type="submit" class="w-full md:w-1/4 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition duration-300">Save</button>
            </div>
        </form>
    </div>
        ...
        <form action="{{ route('candidate.saveProfileStep') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="url" id="social_links_linkedin" name="social_links[linkedin]" value="{{ old('social_links.linkedin', $candidate->social_links['linkedin'] ?? '') }}"
                ...
                <div>
                    ...
                    <input type="url" id="social_links_facebook" name="social_links[facebook]" value="{{ old('social_links.facebook', $candidate->social_links['facebook'] ?? '') }}"
                           class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:border-primary">
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="url" id="social_links_instagram" name="social_links[instagram]" value="{{ old('social_links.instagram', $candidate->social_links['instagram'] ?? '') }}"
                           class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:border-primary">
                </div>
                <div>
                    <label for="social_links_twitter" class="block text-gray-700 font-semibold mb-2">Twitter</label>
                    <input type="url" id="social_links_twitter" name="social_links[twitter]" value="{{ old('social_links.twitter', $candidate->social_links['twitter'] ?? '') }}"
                           class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:border-primary">
                </div>
            </div>
            <div class="items-center justify-end flex mt-4">
        ...
        <form action="{{ route('candidate.saveProfileStep') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location', $candidate->location ?? '') }}"
                           class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:border-primary">
                </div>
                <div>
