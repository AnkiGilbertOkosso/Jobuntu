...
const Navbar = () => {
  ...
  return (
    <>
   <nav className='bg-nav  md:  max-w-screen-2xl mx-auto text-secondary-text top-0 left-0 right-0'>
    <div className="log justify-between items-center flex py-4">
   <img src={logo} alt="" className="logo md:hidden items-center   "/>
   <div className='md:hidden items-center'>

            <button onClick={toggleMenu} className='text-white focus:outline-none focus:text-gray-300'>
                {
                    isMenuOpen ? (<HiMiniXMark className='w-6 h-6 text-black' /> ):(<FaBarsStaggered className='w-6 h-6 text-black' />)
                }
    ...
    <div className='text-x1 text-lg container mx-auto flex justify-between items-center font-medium con'>
        ...
        <div className="items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse hidden lg:flex">
...
{/* navitem */}
<div className={`space-y-4 px-4 pt-24 pb-5 bg-nav ${isMenuOpen ? "block fixed top-0 right-0 left-0" : "hidden"}`}>
    {
      navitems.map(({link,path})=> <a key={link} href={path} className="block text-secondary-text">{link}</a>)  
    }
